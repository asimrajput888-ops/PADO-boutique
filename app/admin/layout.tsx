        ...
        <nav className="space-y-1 flex-1">
          <Link
            ...
            className={`block p-3 rounded-lg text-sm transition ${
              pathname === "/admin/dashboard" ? "bg-neutral-900 text-white" : "hover:bg-neutral-100 text-neutral-700"
            }`}
          >
            Dashboard
          </Link>
          <Link
            href="/admin/products"
            className={`block p-3 rounded-lg text-sm transition ${
              pathname.startsWith("/admin/products") ? "bg-neutral-900 text-white" : "hover:bg-neutral-100 text-neutral-700"
            }`}
          >
            Products
          </Link>
          <Link
            href="/admin/orders"
            className={`block p-3 rounded-lg text-sm transition ${
              pathname === "/admin/orders" ? "bg-neutral-900 text-white" : "hover:bg-neutral-100 text-neutral-700"
            }`}
          >
            Orders
          </Link>
