                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {FABRICS.map((f) => (
                      <button key={f.id} onClick={() => setSelection({ ...selection, fabric: f.id })}
                        className={`p-4 border rounded-xl flex flex-col items-center gap-2 transition-all ${selection.fabric === f.id ? "border-[#5D1A24] bg-[#5D1A24]/5 shadow-md" : "border-[#1E1E2C]/10 hover:border-[#C5A059]"}`}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {LINING_OPTIONS.map((l) => (
                      <button key={l.id} onClick={() => setSelection({ ...selection, lining: l.id })}
                        className={`p-3 border rounded-xl flex flex-col items-center gap-2 transition-all ${selection.lining === l.id ? "border-[#5D1A24] bg-[#5D1A24]/5 shadow-md" : "border-[#1E1E2C]/10 hover:border-[#C5A059]"}`}>
