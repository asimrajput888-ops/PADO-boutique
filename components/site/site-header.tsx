...
export default function SiteHeader() {
  ...
  // Menu structure (Suitsupply style)
  const menuSections = [
    {
      id: "custom-made",
      title: "Custom Made",
      links: [
        { name: "Custom Made Men", href: "/men" },
        { name: "Custom Made Women", href: "/women" },
    ...
    },
    {
      ...
      title: "Ready to Wear",
      links: [
        { name: "Ready to Wear Men", href: "/signature-suit" },
        { name: "Ready to Wear Women", href: "/signature-suit" },
  ...
  return (
    <>
      ...
      {/* ============ SIDE MENU DRAWER (Suitsupply Style) ============ */}
      <AnimatePresence>
        {menuOpen && (
          <>
            {/* Overlay */}
            ...
            >
              ...
              <div className="px-8 py-10">
                {menuSections.map((section) => (
                  <div key={section.id} className="mb-10">
                    ...
                    {/* Sub Links */}
                    <AnimatePresence>
                      {(openSubmenu === section.id || section.id === "custom-made") && (
                        <motion.div
              ...
              {/* Drawer Footer */}
              <div className="px-8 py-6 border-t border-neutral-200 mt-auto">
